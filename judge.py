...
class Board:
    ...
    def show(self):
        ...
        mp[self.pawn[0][0] * 4 + 1][self.pawn[0][1] * 4 + 1] = ord('0')
        mp[self.pawn[1][0] * 4 + 1][self.pawn[1][1] * 4 + 1] = ord('1')
...
if (not len(sys.argv) == 3):
    sys.stderr.write('usage:   ./judge.py ai0Path ai1Path\n')
    sys.stderr.write('         ./judge.py human ai1Path\n')
    sys.stderr.write('example: ./judge.py ./sample_ai ./sample_ai\n')
    sys.stderr.write('         ./judge.py human ./sample_ai\n')
    sys.exit(1)
judge()
